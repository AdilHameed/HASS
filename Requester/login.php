...
$query_result = mysqli_query($con, $check);
  	...
  	{
  		 $message = "<div class='alert alert-warning ' role='alert'> Don't have an account?<a class='btn btn-outline-primary font-weight-bold ml-2' href='../index.php#registration'>Register</a></div>";
  	 
  	
  	}
  	else
  	{
  		  $query = "SELECT r_id,r_email FROM requester WHERE r_email ='$mail' AND r_password = '$pass'";
...
<head>
    ...
    <body>
    	...
    	<p class="mt-5 text-center" style="font-size: 20px"><i class="fas fa-user text-primary"></i> Login to see status</p>
